...
# Template: app
# Command: D:\StudyTool\Qt\6.5.3\mingw_64\bin\qmake.exe -o Makefile Parkingmanager.pro -spec win32-g++ "CONFIG+=qtquickcompiler"
#############################################################################
...
Makefile: Parkingmanager.pro ../../Qt/6.5.3/mingw_64/mkspecs/win32-g++/qmake.conf ../../Qt/6.5.3/mingw_64/mkspecs/features/spec_pre.prf \
		...
		image.qrc
	$(QMAKE) -o Makefile Parkingmanager.pro -spec win32-g++ "CONFIG+=qtquickcompiler"
