...
static constexpr auto qt_meta_stringdata_CLASSPreviewWindowENDCLASS = QtMocHelpers::stringData(
    "PreviewWindow",
    "processConfirmed",
    "",
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSPreviewWindowENDCLASS_t qt_meta_stringdata_CLASSPreviewWindowENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(14, 16),  // "processConfirmed"
        QT_MOC_LITERAL(31, 0),  // ""
        QT_MOC_LITERAL(32, 22)   // "onConfirmButtonClicked"
    },
    "PreviewWindow",
    "processConfirmed",
    "",
...
void PreviewWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->processConfirmed(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &PreviewWindow::processConfirmed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PreviewWindow::processConfirmed()
{
